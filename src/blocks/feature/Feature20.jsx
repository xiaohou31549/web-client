...
export default function Feature20({ heading, caption, closingNote, image, features, actionBtn, secondaryBtn }) {
    ...
    <ContainerWrapper sx={{ py: SECTION_COMMON_PY }}>
      <Stack sx={{ gap: { xs: 3, sm: 4, md: 5 } }}>
        ...
        <Stack sx={{ alignItems: 'center', gap: 3 }}>
          <Typography variant="h6" sx={{ color: 'text.secondary', maxWidth: { xs: '75%', sm: '45%', md: '60%' }, textAlign: 'center' }}>
            <motion.div
