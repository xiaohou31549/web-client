...
const data = [
  {
    ...
    menu: [
      ...
      {
        label: 'Blog',
        link: { href: 'https://blog.xxx.io/', ...linkProps }
      },
      {
        label: 'Refund Policy',
  ...
  },
  {
    ...
    menu: [
      {
        label: 'Pricing',
        link: { href: 'https://mui.com/store/items/xxx-multipurpose-ui-kit-and-dashboard/', ...linkProps }
      },
      {
        label: 'FAQs',
        link: { href: 'https://phoenixcoded.gitbook.io/xxx/faq', ...linkProps }
      },
      {
        label: 'Support',
    ...
    menu: [
      {
        ...
        link: {
          href: 'https://blog.xxx.io/a-decade-of-expertise-the-phoenixcoded-story-and-why-you-should-trust-us',
          ...linkProps
        }
      },
      {
        label: 'About',
        link: { href: 'https://xxx.io/about', ...linkProps }
      },
      {
        label: 'Contact Us',
